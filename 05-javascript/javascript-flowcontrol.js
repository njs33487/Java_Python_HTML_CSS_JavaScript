...
function branchingFunctionTwo(){
    ...
    //notice that switch case does a strict comparison, so it used "==="
    switch(4){
        case '4':
            console.log("1st");
            break;
...
// console.log("\n\n\n\n\n\n\n\n\n\n\n\n");
///more on forloops
var myArray= [88, "Danny Boy", true, "blue", 42, "set, hike!"];
var myObjee= {"element1": 66, "element2": "peanuts!!!! get your peanuts!"}

//"for of" loop
//cycles through elements/values of an iterable object
for(var temporaryTrevin of myArray){
// for(var temporaryTrevin of myObjee){ //<---not iterable so there is an error
...
myObjee.newAttribute = "new value";

//"for in" loop
//cycles through indices or attributes/keys
// for(var temporaryTrevin in myArray){
for(var temporaryTrevin in myObjee){
    console.log(temporaryTrevin);
    // console.log(myObjee[temporaryTrevin]);
